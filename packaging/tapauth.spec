...
install -m 0644 tapauthd/org.tapauth.config.admin.policy %{buildroot}%{_datadir}/polkit-1/actions/org.tapauth.config.admin.policy
...
%{_datadir}/polkit-1/actions/org.tapauth.config.admin.policy