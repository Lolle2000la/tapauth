...
if [ -f /usr/share/polkit-1/actions/dev.rourunisen.tapauth.config.admin.policy ]; then
    echo "Removing polkit policy..."
    rm /usr/share/polkit-1/actions/dev.rourunisen.tapauth.config.admin.policy
fi
