...
/**
 * Application configuration manager using SharedPreferences. Provides user-configurable settings
...
class AppConfiguration private constructor(context: Context) {
    ...
    companion object {
        ...
        @Volatile private var instance: AppConfiguration? = null
    ...
    /**
     * UDP port for authentication requests. Default: 36692 (specification-defined) Must be
     * user-configurable per specification requirements.
     */
    var udpPort: Int
    ...
    /** Session timeout in seconds. Default: 120 seconds per specification */
    ...
    /** Whether BLE GATT service is enabled. Default: true */
    ...
    /** Whether UDP server is enabled. Default: true */
    ...
    var udpRunning: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean(KEY_UDP_RUNNING, value).apply()
        }
    ...
    var bleRunning: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean(KEY_BLE_RUNNING, value).apply()
        }
