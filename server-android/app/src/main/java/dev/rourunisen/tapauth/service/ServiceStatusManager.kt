...
/**
 * Singleton that holds live service status using StateFlow so UI can collect updates
 * in a lifecycle-aware manner. Services should call update methods when their real
 * runtime state changes. State is also persisted to AppConfiguration.
 */
