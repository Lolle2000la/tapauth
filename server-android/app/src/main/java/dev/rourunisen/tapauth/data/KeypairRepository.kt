...
/**
 * Manages the server's Ed25519 keypair for signing authentication grants.
 * The keypair is generated once and stored securely using Android Keystore.
 */
class KeypairRepository(private val context: Context) {
    ...
    fun hasKeypair(): Boolean {
        return prefs.contains(KEY_PRIVATE_KEY_ENCRYPTED) && 
