...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_generateX25519Keypair(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in generateX25519Keypair".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createAuthGrant(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createAuthGrant".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_parseEncryptedPacketStructure(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in parseEncryptedPacketStructure".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_extractTemporalIdentifier(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in extractTemporalIdentifier".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_generateTemporalIdBle(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in generateTemporalIdBle".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_serializeAuthRequestForVerification(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let challenge_b64 = json_value.get("challenge").and_then(|v| v.as_str()).unwrap_or("");
        ...
        let auth_request = pb::AuthenticationRequest {
            challenge,
            username: json_value.get("username").and_then(|v| v.as_str()).unwrap_or("").to_string(),
            hostname: json_value.get("hostname").and_then(|v| v.as_str()).unwrap_or("").to_string(),
            timestamp_unix_seconds: json_value.get("timestamp_unix_seconds").and_then(|v| v.as_u64()).unwrap_or(0),
            signature_algorithm: json_value.get("signature_algorithm").and_then(|v| v.as_i64()).unwrap_or(0) as i32,
            signature: vec![],
        };
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in serializeAuthRequestForVerification".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_parseGrantConfirmation(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in parseGrantConfirmation".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_parseAuthenticationCancel(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in parseAuthenticationCancel".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createGrantWrapperMessage(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createGrantWrapperMessage".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createDenialWrapperMessage(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createDenialWrapperMessage".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createEncryptedPacket(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createEncryptedPacket".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_decryptEncryptedPacket(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in decryptEncryptedPacket".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createPairingCskMessage(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createPairingCskMessage".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_parsePairingCskMessage(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in parsePairingCskMessage".to_string());
            std::ptr::null_mut()
        }
    }
}
...
pub extern "system" fn Java_dev_rourunisen_tapauth_crypto_TapAuthCrypto_createPairingComplete(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        Ok(result) => result,
        Err(_) => {
            throw_illegal_state(&mut env, "panic caught in createPairingComplete".to_string());
            std::ptr::null_mut()
        }
    }
}
